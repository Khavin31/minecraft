...
function new_image(get_image){
    fabric.Image.fromURL(get_image, function(Img){
        blocks_object=Img;
        blocks_object.scaleToWidth(block_width);
        blocks_object.scaleToHeight(block_height);
        blocks_object.set({
            top:player_y,
            left:player_x
        });
...
function up(){
    if (player_y>=0) {
        ...
        console.log("height of the block is ="+block_height);
...
function left(){
    if (player_x>=0) {
        ...
        console.log("width of the block is ="+block_width);
        console.log("X="+player_x+"Y="+player_y);
        canvas.remove(player_object);
        player_update();
    }
